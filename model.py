...
class Separator(BaseModel):
    def __init__(
            ...
            fdrc,
            num_freqs,
            fb_freqs,  # number of low frequency bins extracted from fullband model_zoo input.
            freq_cutoffs,
            sb_num_center_freqs,
            sb_num_neighbor_freqs,
            fb_num_center_freqs,
    ...
    def forward(self, noisy_y):
        ...
        fb_output, _ = self.fb_model(fb_input)  # [B, F, T]
        ...
        df_coefs_list, _ = self.sb_model(noisy_mag, fb_output)
